...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-menu { background: none; border: none; cursor: pointer; color: var(--text-muted); font-size: 1.1rem; margin-right: 0.5rem; transition: color 0.2s; }
        ...
        .alert { padding: .9rem 1.1rem; border-radius: var(--radius); font-size: .88rem; display: flex; align-items: center; gap: .6rem; margin-bottom: 1.2rem; }
...
resizer.addEventListener('mousedown', (e) => {
    ...
    document.querySelector('.main-wrapper').style.transition = 'none';
});
...
document.addEventListener('mouseup', () => {
    if(isResizing) {
        ...
        sidebar.style.transition = 'transform .3s ease, width .3s ease';
        document.querySelector('.main-wrapper').style.transition = 'margin-left .3s ease';
        localStorage.setItem('sidebar-w', document.documentElement.style.getPropertyValue('--sidebar-w'));
    }
});

...
<style>
    ...
    @media print {
        ...
        body { margin: 1.5cm !important; background: #ffffff !important; color: #000000 !important; font-family: 'Times New Roman', Times, serif !important; }
...
<div class="print-document">
    ...
    <div class="judul-laporan">
        <div class="judul-utama">BUKTI TRANSAKSI PEMINJAMAN BUKU BOS</div>
    ...
    <div class="section-title">DAFTAR BUKU BOS YANG DIPINJAM</div>
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $detail->tanggal_jatuh_tempo ? $detail->tanggal_jatuh_tempo->format('d/m/Y') : 'Akhir Semester' }}</td>
...
<div class="detail-wrap">
    ...
    <div class="pg-head">
        <div class="pg-head-left">
            ...
            <div>
                <h1 class="pg-title">Detail Sirkulasi Peminjaman BOS</h1>
            </div>
        </div>
    ...
    <div class="section-card">
        ...
        <div class="info-grid" style="border-bottom: 1px solid #e2e8f0; background: #fafafa; padding: 1.25rem 1.75rem;">
            ...
            <div class="info-block" style="grid-column: span 2;">
                ...
                <span class="info-value" style="font-size: 0.95rem; color: #475569;">{{ $peminjaman->details->count() }} Buku BOS Terdaftar</span>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($detail->tanggal_jatuh_tempo)
                                ...
                                @endif
                            @else
                                <span style="color: #64748b; font-weight: 600; font-size: 0.85rem">Akhir Semester</span>
                            @endif
                        </td>

...
<div class="print-only">
    <div class="print-header">
        ...
        <div class="print-title">
            <h1>BUKTI TRANSAKSI BUKU BOS</h1>
...
<div class="card">
    <div class="card-header">
        ...
        @php
            $pjmStatus = match($peminjaman->status_peminjaman) {
                ...
                'dikembalikan' => ['Dikembalikan', 'pill-success'],
    ...
    <div class="card-body">
        <div class="summary-grid">
            ...
            <div class="summary-item">
                <span class="summary-label">NIS / Kelas</span>
                <span class="summary-value">{{ $peminjaman->siswa->nis }} • {{ $peminjaman->siswa->kelas }}</span>
            </div>
            <div class="summary-item">
...
<div class="card" style="border: 1px solid #f5c6c2; background: #fffaf9">
    <div class="card-body" style="text-align:center; padding: 1.8rem">
        ...
        <h3 style="font-size:1rem; font-weight:800; margin-bottom:.5rem">Tunggakan Denda BOS</h3>
...
<div class="card">
    <div class="card-header">
        <h2><i class="fas fa-book-open"></i> Koleksi Buku BOS Dipinjam</h2>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <div style="display:flex; align-items:center; gap:.5rem; margin-top:.3rem">
                            <span style="font-size:.7rem; background:#f1f5f9; padding:.1rem .4rem; border-radius:4px; font-weight:700; color:var(--text-muted)">BUKU BOS</span>
                    ...
                    <td>
                        @if($detail->tanggal_jatuh_tempo)
                            ...
                            @endif
                        @else
                            <span style="color:var(--text-muted)">Akhir Semester</span>
                        @endif
                    </td>
                    <td>

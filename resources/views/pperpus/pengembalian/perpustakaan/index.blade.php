        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('pperpus.pengembalian.perpustakaan.formKembali', $pjm->id_peminjaman) }}" class="btn-primary" style="padding:.3rem .7rem; font-size:.75rem">
                            <i class="fas fa-eye"></i> Proses Kembali
                        </a>
                    </td>
                </tr>
                @empty

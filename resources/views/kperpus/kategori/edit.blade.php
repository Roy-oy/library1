...
<div class="layout-grid">
    ...
    <div class="form-card">
        ...
        <form action="{{ route('kperpus.kategori.update', $kategoriBuku->id_kategori) }}" method="POST" id="form-kategori">
            @csrf
            @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        ...
                        <input type="text" id="nama_kategori" name="nama_kategori" 
                               ...
                               value="{{ old('nama_kategori', $kategoriBuku->nama_kategori) }}" placeholder="Contoh: Novel, Sains, Teknologi, Sejarah..." required autofocus>
                    </div>
                    <p class="form-hint">

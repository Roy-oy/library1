...
@else
    <div class="books-grid">
        @foreach($buku as $b)
        {{-- BAGIAN PERBAIKAN UTAMA: Mengikat data ke tag atribut data-* dan memanggil showDetail(this) --}}
        <div class="book-card" 
...
<script>
    function showDetail(element) {
        // Membaca attribute data-* dari element HTML kartu yang diklik
        ...
        // Atur Gambar Cover / Fallback Ikon
        if(buku.gambar) {
        ...
        // Isi Teks Informasi Detail Buku
        ...
        // Tampilkan Modal & Kunci Scroll Halaman Utama
    ...
    function closeModal() {
        ...
        document.body.style.overflow = 'auto'; // Kembalikan fungsionalitas scroll halaman utama
    }

    // Menutup modal otomatis saat menekan tombol Escape di Keyboard
